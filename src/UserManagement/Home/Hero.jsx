...
const Hero = forwardRef(({ refreshFunctionsRef }, ref) => {
  ...
  if (loading) {
    return (
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mb-8 sm:mb-12">
        <div className="relative min-h-[400px] sm:min-h-[500px] md:min-h-[600px] overflow-hidden rounded-2xl shadow-xl w-full mx-auto bg-reptilez-green-50 border border-reptilez-green-200">
          <div className="absolute inset-0 shimmer-bg"></div>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
              <div className="w-16 h-16 border-4 border-reptilez-green-300 border-t-reptilez-green-600 rounded-full animate-spin"></div>
  ...
  if (heroImages.length === 0) {
    return (
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mb-8 sm:mb-12">
        <div className="relative min-h-[400px] sm:min-h-[500px] md:min-h-[700px] overflow-hidden rounded-2xl shadow-xl w-full mx-auto bg-reptilez-green-50 flex items-center justify-center border border-reptilez-green-200">
  ...
  return (
    <div className="w-full mb-8 sm:mb-12">
      <div className={`relative min-h-[400px] sm:min-h-[500px] md:min-h-[650px] overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl w-full mx-auto group transition-all duration-700 border border-reptilez-green-200 ${
        ...
        {heroImages.map((image, index) => (
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(180deg, rgba(250, 250, 250, 0.1) 0%, rgba(250, 250, 250, 0.3) 100%), url("${image}")`,
              transitionDelay: index === currentIndex ? '0ms' : '300ms'
            }}
          >
            <div className={`absolute inset-0 bg-gradient-to-t from-reptilez-green-50/30 via-transparent to-transparent transition-opacity duration-1000 ${
