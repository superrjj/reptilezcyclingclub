  ...
  return (
    <div className="@container">
      <div className="@[480px]:p-4">
        <div 
          className="flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 @[480px]:rounded-lg items-center justify-center p-4 shadow-[0_20px_80px_rgba(0,0,0,0.45)]"
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.35) 0%, rgba(0, 0, 0, 0.6) 100%), url("/bg_team_hero.jpg")`
          }}
        >
