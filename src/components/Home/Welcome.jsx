  ...
  return (
    <section className="flex flex-col items-center gap-4 text-center px-4">
      ...
      <p className="text-white/80 text-base font-normal leading-normal max-w-2xl">
        We are a passionate group of riders dedicated to exploring the best trails, pushing our limits, and building a strong, supportive community. Whether you're a seasoned pro or just starting out, there's a place for you in our pack.
      </p>
    </section>
  );
};
